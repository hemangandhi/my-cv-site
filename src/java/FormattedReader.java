 ...
 * 
 */
public class FormattedReader extends PDFStreamEngine
{
     ...
     */
    public FormattedReader() throws IOException
    {
    ...
    /**
     * Instantiate a new FormattedReader object.  Loading all of the operator mappings
     ...
     */
    public FormattedReader( Properties props ) throws IOException
    {
        super( props );
        this.outputEncoding = null;
        normalize = new TextNormalize(this.outputEncoding);
    ...
    /**
     * Instantiate a new FormattedReader object. This object will load
     * properties from FormattedReader.properties and will apply
     * encoding-specific conversions to the output text.
     *
     * @param encoding The encoding that the output will be written in.
     * @throws IOException If there is an error reading the properties.
     */
    public FormattedReader( String encoding ) throws IOException
    {
        super( ResourceLoader.loadProperties(
                "org/apache/pdfbox/resources/PDFTextStripper.properties", true ));
    ...
    protected void writeString(String text, List<TextPosition> textPositions) throws IOException
    {
        ...
        for(TextPosition tp: textPositions){
            builder.append(tp.getCharacter());
            builder.append("<ftsz>" + tp.getFontSizeInPt() + "<ftsz>");
        }
